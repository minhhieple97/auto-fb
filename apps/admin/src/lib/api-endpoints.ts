...
export const apiEndpoints = {
  ...
  fanpageCurlSource: (id: string) => `/${apiPathSegments.fanpages}/${id}/${apiPathSegments.curlSource}`,
  fanpageSearchSources: (id: string) => `/${apiPathSegments.fanpages}/${id}/${apiPathSegments.searchSources}`,
  fanpageSearchSourcesAdd: (id: string) => `/${apiPathSegments.fanpages}/${id}/${apiPathSegments.searchSourcesAdd}`,
